...
export const FooterSubsection = ({ data }: FooterSubsectionProps): JSX.Element => {
  // Animation setup
  ...
  // Use CMS data for quick links
  const quickLinks = data.quick_links;

  // Use CMS data for legal links
  ...
  const socialLinks = data.social_links.map(item => ({
    name: item.title,
    link: item.link,
    icon: socialIcons.find(icon => icon.name === item.title)?.src || "",
  }));
                    ...
                    <div className="flex flex-col items-start gap-[15px] relative">
                      {quickLinks.map((item, index) => (
                        <motion.a
                          ...
                          href={item.link}
                          className="w-[165px] capitalize font-normal text-bluecolor-4 text-[16px] tracking-[0] leading-[25px] relative hover:text-white transition-colors duration-300"
                    ...
                    <div className="flex flex-col items-start gap-[15px] relative">
                      {legalLinks.map((item, index) => (
                        <motion.a
                          ...
                          href={item.link}
                          className="w-[166px] capitalize font-normal text-bluecolor-4 text-[16px] tracking-[0] leading-[25px] relative hover:text-white transition-colors duration-300"
