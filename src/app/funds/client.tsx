        ...
        >
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mb-16 items-start">
                <h1 className="text-4xl sm:text-[36px] font-medium text-bluecolor-9">
                    <span className="text-goldcolor-i">Explore Our Funds:</span> Blackaion&apos;s Investment Portfolio
                </h1>
                <p className="text-gray-600 leading-relaxed">
                    We showcase our strategic investment funds focused on infrastructure and technology across West Africa. Our funds span renewable energy, sustainable urban development, and tech-driven infrastructure solutions, all designed to generate outstanding returns while creating lasting economic and social impact.
                </p>
            </motion.div>
